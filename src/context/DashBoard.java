...
import ui.custom.grid.table.CreateProductTableModel;
...
public class DashBoard extends BaseWindow {
    ...
    public DashBoard(Translations lang, String title) {
        ...
        navList.add(this.lang.getI18nText(TextCodes.productViewProductNav));
    ...
    private void createMenu() {
        ...
        for (String item : this.navList) {
            ...
            button.addActionListener ((event) -> {
                 if (event.getActionCommand().equals(this.lang.getI18nText(TextCodes.productViewProductNav))) {
                     this.getListener().onEvent("click", event);
                 }
             });
